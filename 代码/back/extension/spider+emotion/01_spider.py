...
# csv头部
writer.writerow(('话题链接', '话题内容', '楼主ID', '楼主昵称', '楼主性别', '发布日期','发布时间', '转发量', '评论量', '点赞量', '评论者ID', '评论者昵称','评论者性别', '评论日期', '评论时间', '评论内容'))

# 设置heades
headers = {
    'Cookie': '_T_WM=''; H5_wentry=H5; backURL=https%3A%2F%2Fm.weibo.cn%2F; ALF=''; MLOGIN=0; '
              ...
              'M_WEIBOCN_PARAMS=oid%3D4471980021481431%26luicode%3D20000061%26lfid%3D4471980021481431%26uicode'
              '%3D20000061%26fid%3D4471980021481431',
...
def get_title_id():
    for page in range(1, 21):
        ...
        time.sleep(1)
        # 周榜单
        api_url = 'https://m.weibo.cn/api/feed/trendtop?containerid=102803_ctg1_8698_-_ctg1_8698&page=' + str(page)
        print(api_url)
        time.sleep(1)
...
def write_csv(jsondata):
    for json in jsondata['data']['data']:
        ...
        if 'Mar' in created_times:
            ...
            pass
        created_time = created_times[3]  # 评论时间
